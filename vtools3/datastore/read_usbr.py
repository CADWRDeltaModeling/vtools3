...
tndx = pd.DatetimeIndex(["2016-11-06 01:00","2016-11-06 02:00","2016-11-06 03:00"])
...
fname = "test.txt"
ts = pd.read_csv(fname,sep="\s+",header=None,index_col=[2,1,0],parse_dates=[["date","time"]],skiprows=[0,1],names=["site","shef","date","time","value"])
...
ts3 = ts2.copy()
convert_index = ts3.index.tz_localize('US/Pacific',ambiguous="infer",nonexistent="shift_backward").tz_convert('Etc/GMT+8')  #.tz_localize(None,ambiguous="infer")
